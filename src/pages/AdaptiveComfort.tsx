...
const comfortDrivers = [
  ...
  },
  {
    ...
    href: "/research#adaptive-comfort-model",
  },
  {
    icon: Wind,
    title: "Air movement can expand comfort",
    text: "ASHRAE and CBE comfort tools show that air movement can raise the upper acceptable operative-temperature boundary under defined conditions.",
    href: "/research#ashrae-55",
  },
  {
    icon: Gauge,
...
const evidenceMetrics = [
  {
    value: "80%+",
    label: "Thermal environments are commonly evaluated against a majority-acceptability target, often expressed as 80% or more occupants satisfied.",
    href: "/research#ashrae-55",
  },
  {
    value: "2 methods",
    label: "ASHRAE 55-2023 uses two main compliance pathways: the standard method and the adaptive method.",
    href: "/research#ashrae-55",
  },
  {
    value: "60,000+",
    label: "Large adaptive comfort re-analysis has used the Global Thermal Comfort Database II with more than 60,000 comfort measurements.",
    href: "/research#global-comfort-database",
  },
  {
    value: "150+",
    label: "A major Personal Comfort Systems review synthesized evidence from more than 150 published PCS studies.",
    href: "/research#pcs-review",
  },
  {
    value: "< 50%",
    label: "Personal comfort systems can require less than half the energy of conventional HVAC because they condition the occupied micro-environment instead of the full room.",
    href: "/research#pcs-review",
  },
  {
    value: "8.9–20.4%",
    label: "Adaptive setpoints and occupancy-informed control have shown total electricity-saving potential in simulated small-office studies.",
    href: "/research#adaptive-setpoints",
  },
  {
    value: "~6%",
    label: "A 1°C setpoint or deadband shift is commonly used as a conservative HVAC energy-saving benchmark.",
    href: "/research#deadband",
  },
  {
    value: "10–15%",
    label: "A 2°C deadband expansion can create meaningful HVAC energy-saving potential when comfort is supported locally.",
    href: "/research#energy-reduction",
  },
];
...
const aceLeverage = [
  {
    ...
    href: "/research#personal-comfort-prediction",
  },
  {
    icon: Cpu,
    ...
    href: "/research#occupant-centric-control",
  },
  {
    icon: Fan,
...
const researchCards = [
  {
    ...
    text: "Provides the formal thermal-comfort framework and explains how satisfactory thermal environments are evaluated.",
    href: "/research#ashrae-55",
  },
  {
    title: "Adaptive comfort model",
    text: "Shows that occupants can accept different indoor temperatures depending on outdoor climate, expectation and adaptive opportunity.",
    href: "/research#adaptive-comfort-model",
  },
  {
    title: "CBE adaptive comfort research",
    text: "Uses large thermal comfort datasets to test and refine adaptive comfort assumptions.",
    href: "/research#global-comfort-database",
  },
  {
    title: "PCS literature",
    text: "Supports individual-level conditioning as a way to improve comfort while reducing unnecessary whole-room conditioning.",
    href: "/research#pcs-review",
  },
  {
    title: "Occupant-centric control",
    text: "Shows the shift toward comfort-energy optimization using occupant feedback, prediction and control intelligence.",
    href: "/research#occupant-centric-control",
  },
  {
    title: "Adaptive setpoint studies",
    text: "Shows how adaptive setpoints and occupancy-informed control can reduce energy use while protecting comfort outcomes.",
    href: "/research#adaptive-setpoints",
  },
];
      ...
      <section className="relative overflow-hidden bg-gradient-hero text-primary-foreground">
        ...
        <div className="container relative z-10 py-24 md:py-32">
          <div className="max-w-4xl">
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-accent">Knowledge · Adaptive comfort</p>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Button asChild size="lg" variant="outline" className="border-white/25 bg-white/10 text-white hover:bg-white/15">
                <Link to="/research#ashrae-55">View research base</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {comfortDrivers.map((item) => {
              ...
              return (
                <Link key={item.title} to={item.href} className="group rounded-3xl border border-border bg-card p-7 shadow-soft transition hover:-translate-y-1 hover:shadow-elegant">
                  ...
                  <p className="mt-4 text-sm font-semibold text-accent">View supporting research →</p>
                </Link>
              );
            })}
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-muted-foreground">
              These figures are research-backed benchmarks and should be validated during pilots for each building context.
            </p>
          </div>
          <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
            {evidenceMetrics.map((metric) => (
              <Link key={metric.value + metric.label} to={metric.href} className="group rounded-3xl border border-border bg-card p-7 shadow-soft transition hover:-translate-y-1 hover:shadow-elegant">
                ...
                <p className="mt-4 text-sm font-semibold text-accent">Research source →</p>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {aceLeverage.map((item) => {
              const Icon = item.icon;
              return (
                <Link key={item.title} to={item.href} className="group rounded-3xl border border-white/15 bg-white/8 p-7 shadow-soft transition hover:-translate-y-1 hover:bg-white/12 hover:shadow-elegant">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {researchCards.map((item) => (
              <Link key={item.title} to={item.href} className="group rounded-3xl border border-border bg-card p-7 shadow-soft transition hover:-translate-y-1 hover:shadow-elegant">
                ...
                <p className="mt-3 leading-7 text-muted-foreground">{item.text}</p>
                <p className="mt-4 text-sm font-semibold text-accent">Open reference →</p>
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="container">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              ...
              <h2 className="mt-3 font-display text-3xl font-bold md:text-5xl">Why this supports ACE.</h2>
              <p className="mt-5 text-lg leading-8 text-muted-foreground">
